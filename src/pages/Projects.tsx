...
import { FaBuilding, FaCity, FaPlaceOfWorship, FaHandshake, FaGlobe, FaCertificate, FaTools, FaCheckCircle, FaLaptopHouse, FaHeadset, FaMapMarkedAlt } from 'react-icons/fa';
