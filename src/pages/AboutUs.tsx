...
export default function AboutUs() {
  ...
  return (
    <div className="flex flex-col items-center bg-neutral-light text-text-dark min-h-[calc(100vh-120px)]">
      ...
      <motion.section
        className="w-full py-12 md:py-16 bg-primary-blue text-text-light text-center shadow-lg px-8 md:px-12" // Ensure padding is consistent
        initial="hidden"
        animate="visible"
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.h1 className="text-3xl sm:text-4xl md:text-5xl font-poppins font-bold leading-tight mb-4 text-white" variants={itemVariants}>
          ...
          {/* Adjusted text size for better mobile fit */}
          <motion.p className="text-lg sm:text-xl md:text-2xl font-opensans opacity-90 mb-4" variants={itemVariants}>
            Your Trusted Partner in Advanced Security and Surveillance
          </motion.p>
          {/* Adjusted text size for better mobile fit */}
          <motion.p className="text-base sm:text-md md:text-lg font-opensans opacity-80" variants={itemVariants}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.h2 className="text-3xl sm:text-4xl font-poppins font-bold text-secondary-blue mb-10" variants={itemVariants}> {/* Adjusted title size */}
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            <motion.div className="md:w-1/2 text-left" variants={itemVariants}>
              ...
              {/* Adjusted h3 size */}
              <h3 className="text-xl sm:text-2xl font-poppins font-semibold text-primary-blue mb-4">From Humble Beginnings to Industry Leaders</h3>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.h2 className="text-3xl sm:text-4xl font-poppins font-bold mb-10 text-white" variants={itemVariants}> {/* Adjusted title size */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <motion.div className="p-8 bg-primary-blue/70 rounded-xl shadow-xl border border-accent-light" variants={itemVariants}>
              ...
              <h3 className="text-lg sm:text-xl font-poppins font-semibold mb-3 text-white">Our Mission</h3> {/* Adjusted h3 size */}
              <p className="text-base sm:text-lg opacity-90"> {/* Adjusted text size */}
            ...
            <motion.div className="p-8 bg-primary-blue/70 rounded-xl shadow-xl border border-accent-light" variants={itemVariants}>
              ...
              <h3 className="text-lg sm:text-xl font-poppins font-semibold mb-3 text-white">Our Vision</h3> {/* Adjusted h3 size */}
              <p className="text-base sm:text-lg opacity-90"> {/* Adjusted text size */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={itemVariants} className="p-6 rounded-xl shadow-lg border border-neutral-medium bg-white hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-poppins font-semibold text-primary-blue mb-2">Integrity</h3> {/* Adjusted h3 size */}
            ...
            <motion.div variants={itemVariants} className="p-6 rounded-xl shadow-lg border border-neutral-medium bg-white hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-poppins font-semibold text-primary-blue mb-2">Excellence</h3> {/* Adjusted h3 size */}
            ...
            <motion.div variants={itemVariants} className="p-6 rounded-xl shadow-lg border border-neutral-medium bg-white hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-poppins font-semibold text-primary-blue mb-2">Customer Focus</h3> {/* Adjusted h3 size */}
      ...
      >
        <div className="max-w-4xl mx-auto">
          <motion.h2 className="text-2xl sm:text-3xl font-poppins font-bold mb-8 text-white" variants={itemVariants}> {/* Adjusted title size */}
            Our Accreditations
          </motion.h2>
          <motion.div className="flex flex-col md:flex-row justify-center items-center gap-8" variants={{ visible: { transition: { staggerChildren: 0.2 } } }}>
            <motion.div variants={itemVariants} className="flex flex-col items-center text-center text-base sm:text-lg font-semibold text-white"> {/* Adjusted text size and added flex-col for better stacking on mobile */}
              <FaAward className="text-accent-light text-4xl mb-2" />
              ISO 9001:2015 Certified
            </motion.div>
            <motion.div variants={itemVariants} className="flex flex-col items-center text-center text-base sm:text-lg font-semibold text-white"> {/* Adjusted text size and added flex-col for better stacking on mobile */}
              <FaBuilding className="text-accent-light text-4xl mb-2" />
      ...
      >
        <div className="max-w-3xl mx-auto">
          <motion.h2
            className="text-3xl sm:text-4xl font-poppins font-bold text-primary-blue mb-6" // Adjusted title size
            variants={itemVariants}
          >
            Partner with the Experts
          </motion.h2>
          <motion.p
            className="text-lg sm:text-xl text-text-dark mb-8" // Adjusted text size
            variants={itemVariants}
          >
          ...
          <motion.div variants={itemVariants}>
            <Link
              to="/contact"
              className="bg-secondary-blue hover:bg-primary-blue text-text-light text-lg sm:text-xl font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105 inline-block" // Adjusted text size
            >
              Get in Touch
            </Link>
          </motion.div>
